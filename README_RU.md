...
Перетащи в окно выгруженный JSON. Посчитаются: траты по месяцам, рестораны против магазинов, топ заведений, размер чека, время заказа, что берёшь чаще всего. Интерфейс самой страницы — английский; суммы форматируются по локали браузера.
